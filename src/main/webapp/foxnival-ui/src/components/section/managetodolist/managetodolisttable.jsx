...
import TaskDetailDrawer from "./taskdetailsdrawer";
import UserDetailDrawer from "./userdetailsdrawer";
    ...
    switch (name) {
      ...
      case "assignedTime":
        return !value
          ...
          ? "Assigned time cannot be in the past"
          : "";
      default:
        return "";
    }
  ...
  const filteredTasks = useMemo(() => {
    return tasks.filter(
      (task) =>
        ...
        task.assignedTo
          .toLowerCase()
          .includes(assignedToSearchQuery.toLowerCase()) &&
